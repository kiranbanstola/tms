...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Ticket and Tour Management System</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Tour History</h3>
...
tblbooking.TransportId as transportid,
tbltransport.TransportName as transportname,
...
from tblbooking  join tbltourpackages on tbltourpackages.PackageId=tblbooking.PackageId
 				 join tbltransport on tbltransport.TransportId=tblbooking.TransportId where UserEmail=:uemail";
$query = $dbh->prepare($sql);
...
<td><?php echo htmlentities($result->transportid);?></td>
